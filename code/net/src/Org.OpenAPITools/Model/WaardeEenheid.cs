...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WaardeEenheid :  IEquatable<WaardeEenheid>, IValidatableObject
    {
        ...
        public WaardeEenheid(string eenheid = default(string), string waarde = default(string))
        {
            ...
            if (eenheid == null)
            {
                throw new InvalidDataException("eenheid is a required property for WaardeEenheid and cannot be null");
            }
            else
            {
            ...
            if (waarde == null)
            {
                throw new InvalidDataException("waarde is a required property for WaardeEenheid and cannot be null");
            }
            else
            {
                this.Waarde = waarde;
        ...
        /// </summary>
        [DataMember(Name="eenheid", EmitDefaultValue=true)]
