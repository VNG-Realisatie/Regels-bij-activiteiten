...
class Locatie(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, identificatie, type, werkpakket_code, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            geometrie_bron (str): <body><p>De bron die is gebruikt voor, dan wel de wijze van inwinning van de geometrie.</p></body><body><p>De bron die is gebruikt voor, dan wel de wijze van inwinning van de geometrie.</p></body><body><p>De bron die is gebruikt voor, dan wel de wijze van inwinning van de geometrie.</p></body><body><p>Een inhoudelijke toelichting op de toepassing van het informatie-element.</p></body>. [optional]  # noqa: E501
